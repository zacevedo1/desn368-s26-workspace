...
#Travis Intstructions
- You'll need to get img url's from snipboard.io for the images. Just upload the images to snipboard and replace the <img src="url-goes here" > 
